...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Votre facture DigitalHippo"),
            ...
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { align: "right", style: tableCell },
                        React.createElement(components_1.Text, { style: heading }, "Facture"))),
                React.createElement(components_1.Section, { style: informationTable },
                    React.createElement(components_1.Row, { style: informationTableRow },
                        ...
                        React.createElement(components_1.Column, { style: informationTableColumn },
                            React.createElement(components_1.Text, { style: informationTableLabel }, "DATE ACHAT"),
                            React.createElement(components_1.Text, { style: informationTableValue }, (0, date_fns_1.format)(date, "dd MMM yyyy"))),
                        React.createElement(components_1.Column, { style: informationTableColumn },
                            React.createElement(components_1.Text, { style: informationTableLabel }, "COMMANDE ID"),
                ...
                React.createElement(components_1.Section, { style: productTitleTable },
                    React.createElement(components_1.Text, { style: productsTitle }, "Information commande")),
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            React.createElement(components_1.Link, { href: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(orderId), style: productLink }, "T\u00E9l\u00E9chargez votre contenu")),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: { paddingLeft: "40px", paddingTop: 20 } },
                        React.createElement(components_1.Text, { style: productTitle }, "Frais de transaction")),
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: "right" },
                ...
                React.createElement(components_1.Text, { style: footerLinksWrapper },
                    React.createElement(components_1.Link, { href: "#" }, "Param\u00E8tres du compte"),
                    " \u2022",
                    " ",
                    React.createElement(components_1.Link, { href: "#" }, "Conditions de vente"),
                    " \u2022",
                    " ",
                    React.createElement(components_1.Link, { href: "#" }, "Politique de confidentialit\u00E9")),
                React.createElement(components_1.Text, { style: footerCopyright },
                    "Copyright \u00A9 ",
                    getFullYear === 2024 ? "" : "2024 ",
                    getFullYear,
                    " DigitalHippo Inc. ",
                    React.createElement("br", null),
                    " ",
                    React.createElement(components_1.Link, { href: "#" }, "Tous droits r\u00E9serv\u00E9s"))))));
};
